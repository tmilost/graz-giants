<template>
  <div class="main-header">
    <div class="relative h-[350px] sm:h-[800px] w-full">
      <img class="block h-full w-full object-cover" src="@/assets/4c7af6b98931d7e8c78d7dfce9d258250b3fd5d0.jpg"
      ...
      <div
        ...
        <span class="text-[32px] font-normal sm:text-[72px]">Blue & Yellow. Built for Battle.</span>
      </div>
      <div class="absolute bottom-[70px] left-1/2 hidden -translate-x-1/2 items-center gap-5 sm:flex">
        <input type="radio" name="header-slide"
